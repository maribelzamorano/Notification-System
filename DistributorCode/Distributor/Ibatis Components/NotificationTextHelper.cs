...
namespace com.topdev.aa.data
{
    public class NotificationTextHelper : Helper
    {
        ...
        public bobjNotificationText SelectbySubscriptionType(string id)
        {
            return (bobjNotificationText)Mapper().QueryForObject("NotificationText.SelectbySubscriptionType", id);
        }
