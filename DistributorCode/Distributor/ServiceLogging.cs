...
namespace Distributor
{
    public class ServiceLogging
    {
        public static void LogError(Exception ex)
        {
            ...
            System.IO.File.AppendAllText(GetLogPath() + "\\Distributor_ErrorLog.txt", str);
        }
        ...
        public static void LogDebug(string text)
        {
            try
            {
                ...
                {
                    System.IO.File.AppendAllText(GetLogPath() + "\\Distributor_DebugLog.txt", DateTime.Now.ToString() + "  " + text + "\r\n");
                }
            }
            catch
            { }
